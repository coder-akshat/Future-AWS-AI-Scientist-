...
def calculates_results_stats(results_dic):
    ...
    for key in results_dic:
        # Tally counts of label matches
        if results_dic[key][2] == 1:
            results_stats_dic['n_match'] += 1

        # Tally counts of correctly classified dog breeds
        if results_dic[key][3] == 1 and results_dic[key][2] == 1:
            results_stats_dic['n_correct_breed'] += 1
        
        # Tally counts of dog images
        if results_dic[key][3] == 1:
            results_stats_dic['n_dogs_img'] += 1
            
            # Tally counts of correctly classified dogs
            if results_dic[key][4] == 1:
                results_stats_dic['n_correct_dogs'] += 1
        
        # Tally counts of correctly classified non-dog images
        else:
            if results_dic[key][4] == 0:
                results_stats_dic['n_correct_notdogs'] += 1

    # Calculates statistics based on the counters
    results_stats_dic['n_images'] = len(results_dic)
    results_stats_dic['n_notdogs_img'] = results_stats_dic['n_images'] - results_stats_dic['n_dogs_img']

    # Calculates percentage of label matches
    ...
    # Calculates percentage of correctly classified non-dogs
